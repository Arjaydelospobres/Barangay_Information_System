...
<head>
	...
	<title>Solo Parent Permit of Barangay Camp Tinio</title>
    <style>
        @page  
        { 
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Barangay Solo Parent</div>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            ...
                                            <h2 class="mt-5 ">Sa kinauukulan:</h2>
                                             ...
                                             <h2 class="mt-5" style="text-indent: 40px;">Batay sa talaan ng Barangay na ito na si<span class="fw-bold" style="font-size:35px"> G./Gng. <?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></span> ,<span class="fw-bold" style="font-size:35px"> <?= ucwords($resident['age']) ?> </span></span>taong gulang na may<span class="fw-bold" style="font-size:35px"> ______</span> anak, ay kasalukuyang naninirahan sa<span class="fw-bold" style="font-size:35px"> <?= ucwords($resident['purok']) ?> </span>Camp Tinio, Cabanatuan City, ay isang tahimik na mamayan ng Barangay na ito</h2>

                                             <h2 class="mt-5" style="text-indent: 40px;">Pinatunayan din ng tanggapang ito na siya ay Solo Parent at walang anumang kaso o gulo na kinasasangkutan hanggang kasulukuyan.</h2>

                                             <h2 class="mt-5" style="text-indent: 40px;">Iginawad ang pagpapatunay ito sa kahilingan ni <span class="fw-bold" style="font-size:35px"><?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?></span> para sa anu mang legal na paggagamitan ngayong <span class="fw-bold" style="font-size:35px"><?= date('m/d/Y') ?></span> dito sa Tanggapan ng Punong Barangay, Camp Tinio, Cabanatuan City.</h2>
                                        ...
                                        <div class="col-md-12">
                                            <div class="p-3 text-right mr-5" style="margin-top:100px">
                                                <h1 class="fw-bold mb-0 text-uppercase" style="font-size:35px"><?= ucwords($captain['name']) ?></h1>
                                                <p class="fw-bold mr-5">PUNONG BARANGAY&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p>
                                            </div>
                                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Request Solo Parent Permit</h5>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_pment.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"  name="details">Solo Parent</textarea>
