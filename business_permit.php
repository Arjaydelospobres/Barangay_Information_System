										...
										<?php if(isset($_SESSION['username'])):?>
											<div class="card-tools">
												<a href="#add" data-toggle="modal" class="btn btn-info btn-border btn-round btn-sm">
													<h4><b><i class="fa fa-plus"></i>&nbsp Business Permit</h4>
												</a>
											</div>
										<?php endif?>
									</div>
														...
														<td>
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" href="generate_business_permit.php?id=<?= $row['id'] ?>" class="btn btn-link btn-primary" data-original-title="Generate Permit">
																	<i class="fas fa-file-alt"></i>&nbsp Generate
																</a>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_permit.php" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Business Address" name="add" required>
                                </div>
								<div class="form-group">
