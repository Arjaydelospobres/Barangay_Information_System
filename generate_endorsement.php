...
<head>
	...
	<title>Endorsement -  Barangay Management System</title>
    <style>
        @page  
        { 
...
<?php include 'templates/loading_screen.php' ?>
	<div class="wrapper">
		...
		<div class="main-panel">
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Barangay Endorsement Certificate</div>
            ...
            <h1 class="fw-bold mb-0" style="font-size:30px;">OFFICE OF THE PUNONG BARANGAY</i></h2>
									</div>
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            
                                            <div class="text-center">
                                                <h1 class="mt-4 mb-5" style="font-size:38px;color:black">ENDORSEMENT</h1>
                                            </div>
                                             ...
                                             <h2 class="mt-5" style="text-indent: 40px;">Respectfully referring to Engr. George Garcia, City Building Official, City Governement of Cabanatuan City, herein resident of Barangay Camp Tinio, for his/her Electrical Permit and Installation.</h2>

                                             <h2 class="mt-5" style="text-indent: 40px;">I herby certify that<span class="fw-bold" style="font-size:35px"> <?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?> </span>resides at<span class="fw-bold" style="font-size:35px"> <?= ucwords($resident['purok']) ?> </span>, Camp Tinio, Cabanatauan City.</h2>
                                        ...
                                        <div class="col-md-12">
                                            <div class="p-3 text-right mr-5" style="margin-top:120px">
                                                                                                <h1 class=" mb-0 text-uppercase" style="font-size:35px"><?= ucwords($captain['name']) ?></h1>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Request Endorsement Permit</h5>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_pment.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"  name="details">Endorsement</textarea>
