		...
		<div class="main-panel">
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Barangay BLK / ZONE</div>
										<div class="card-tools">
											<a href="#add" data-toggle="modal" class="btn btn-info btn-border btn-round btn-sm">
                                            <h4><b><i class="fa fa-plus"></i>&nbsp Blk/Zone</h4>
											</a>
										</div>
									</div>
								</div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Create BLK / ZONE</h5>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_purok.php" >
                                <div class="form-group">
                                    <label>BLK / ZONE Name</label>
                                    <input type="text" class="form-control" placeholder="Enter BLK / ZONE Name" name="purok" required>
                                </div>
                                <div class="form-group">
                                    <label>BLK / ZONE Details(Optional)</label>
                                    <textarea class="form-control" placeholder="Set Bounderies for each BLK / ZONE" name="details"></textarea>
                                </div>
            ...
            <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Edit BLK / ZONE</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form method="POST" action="model/edit_purok.php" >
                                <div class="form-group">
                                    <label>BLK / ZONE Name</label>
                                    <input type="text" class="form-control" id="purok" placeholder="Enter BLK / ZONE Name" name="purok" required>
                                </div>
                                <div class="form-group">
                                    <label>BLK / ZONE Details(Optional)</label>
                                    <textarea class="form-control" id="details" placeholder="Set Bounderies for each BLK / ZONE" name="details"></textarea>
                                </div>
