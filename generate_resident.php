								...
								<div class="card-body m-5" id="printThis">
                                    <div class="d-flex flex-wrap justify-content-center" style="border-bottom:1px solid red">
										<div class="text-center">
											...
											<h1 class="fw-bold mb-0">Barangay Camp Tinio</i></h1>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                     <div class="form-group row">
                                                        <h4 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Government ID </h4>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                        <input type="text" class="form-control fw-bold" style="font-size:20px" value="<?= $resident['gv_id'] ?>">
                                                    </div>
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="form-group row">
                                                        <h4 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Government ID No.</h4>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group row">
                                                <h4 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Occupation:</h4>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <input type="text" class="form-control fw-bold" style="font-size:20px" value="<?= $resident['occupation'] ?>">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group row">
                                                <h3 class="mt-5 col-lg-4 col-md-4 col-sm-4 mt-sm-2 text-left">Personal Condition:</h3>
                                            </div>
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <input type="text" class="form-control fw-bold" style="font-size:20px" value="<?= $resident['con'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 text-left">
                                                <input type="text" class="form-control fw-bold" style="font-size:20px" value="<?= $resident['address'] ?>">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group row">
