...
<head>
	...
	<title>Guarian Certificate  Permit of Barangay Camp Tinio</title>
    <style>
        @page  
        { 
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">Barangay Guardian Certificate</div>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            ...
                                            <h2 class="mt-5 fw-bold">SA KINAUUKULAN:</h2>
                                             ...
                                             <h2 class="mt-5" style="text-indent: 40px;">Ito ay pagpapatunay na si<span class="fw-bold" style="font-size:35px"> <?= ucwords($resident['firstname'].' '.$resident['middlename'].' '.$resident['lastname']) ?>, <?= ucwords($resident['age']) ?> </span>taong gulang, naninirahan sa <span class="fw-bold" style="font-size:35px"> <?= ucwords($resident['purok']) ?> </span>, Camp Tinio, Cabanatuan City. na siyang kumukupkop at tumatayong magulang at nangangalaga kay<span class="fw-bold" style="font-size:35px"> _____________, ______</span> taong gulang, simula pa noong <span class="fw-bold" style="font-size:35px">_________</span> hanggang sa kasalukuyan.</h2>

                                             <h2 class="mt-5" style="text-indent: 40px;">Na, ang pagpapatunay na ito ay iginawad sa kahilingan ni <span class="fw-bold" style="font-size:35px">________</span> para sa anumang legal na paggagamitan. </h2>

                                             <h2 class="mt-5" style="text-indent: 40px;">Iginawad ngayon ika-<span class="fw-bold" style="font-size:35px"><?= date('m/d/Y') ?></span>, dito sa Tanggapan ng Punong Barangay Camp Tinio, Cabanatuan City.</h2>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Request Guardian Certificate</h5>
                        ...
                        <div class="modal-body">
                            <form method="POST" action="model/save_pment.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"  name="details">Guardian Certificate</textarea>
