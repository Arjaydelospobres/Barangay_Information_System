...
<?php 
 $query = "SELECT * FROM tblposition ORDER BY `order`";
    ...
    if($state=='Disease'){
        $query = "SELECT * FROM tblresident WHERE con='Disease' AND resident_type=1";
        $result = $conn->query($query);
    }elseif($state=='female'){
...
<head>
    ...
    <title>Disease Resident of Camp Tinio</title>
</head>
<body>
                    ...
                    <div class="row mt--2">
                        ...
                        <div class="col-md-3">
                             ...
                             <div class="card card-stats card-secondary card-round">
                                ...
                                <div class="card-body">
                                    <a href="resident_info.php?state=Disease" class="card-link text-light">All Disease </a>
                                </div>
                            </div>
