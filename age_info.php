                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold ">&nbsp&nbsp&nbspPreschool &nbsp &nbsp&nbsp&nbsp(1-5 ages)</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <a href="1to5_info.php?state=age1" class="card-link text-light">All 1-5 ages </a>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats card-warning card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold ">&nbsp&nbsp&nbspGradeschooler &nbsp &nbsp&nbsp&nbsp(6-12 ages)</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <a href="6to12_info.php?state=age2" class="card-link text-light">All 6-12 ages </a>
                                </div>
                            </div>
                            <div class="card card-stats card-warning card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold ">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspTeen &nbsp &nbsp&nbsp&nbsp(13-18 ages)</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <a href="13to18_info.php?state=age3" class="card-link text-light">All 13-18 ages </a>
                                </div>
                            </div>
                             <div class="card card-stats card-warning card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold ">&nbsp&nbsp&nbspYoung Adult &nbsp &nbsp&nbsp&nbsp(19-21 ages)</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <a href="19to21_info.php?state=age4" class="card-link text-light">All 19-21 ages </a>
                                </div>
                            </div>
                            <div class="card card-stats card-warning card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold ">&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAdult &nbsp &nbsp&nbsp&nbsp(22-59 ages)</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <a href="22to59_info.php?state=age5" class="card-link text-light">All 22-59 ages </a>
                                </div>
                            </div>
