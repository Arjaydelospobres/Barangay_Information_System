                    ...
                    <div class="row mt--2">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card card-stats card-warning card-round">
                                ...
                                <div class="card-body">
                                    <a href="e_info.php?state=employed" class="card-link text-light">All Employed Resident </a>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats card-warning card-round">
                                ...
                                <div class="card-body">
                                    <a href="noneemp_info.php?state=none" class="card-link text-light">None </a>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats card-secondary card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold ">Unemployed</h5>
                                ...
                                <div class="card-body">
                                    <a href="unemployed.php?state=unemployed" class="card-link text-light">All Unemployed Resident </a>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats card-warning card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold ">Underemployed</h5>
                                ...
                                <div class="card-body">
                                    <a href="underemployed.php?state=underemployed" class="card-link text-light">All Underemployed Resident </a>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats card-warning card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold ">Self-Employed</h5>
                                ...
                                <div class="card-body">
                                    <a href="selfemployed.php?state=self" class="card-link text-light">All Self-Employed Resident </a>
                                </div>
                            </div>
