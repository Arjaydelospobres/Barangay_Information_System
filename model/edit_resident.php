<?php 
	...
	$gvstatus		= $conn->real_escape_string($_POST['gvstatus']);
    ...
    $costatus		= $conn->real_escape_string($_POST['costatus']);
	...
	if($nat['id'] == $id || count($nat) <= 0){
		if(!empty($id)){
			...
			if(!empty($profile) && !empty($profile2)){
				...
				$query = "UPDATE tblresident SET national_id='$national_id',`gv_id`='$gvstatus',citizenship='$citi',`picture`='$profile', `firstname`='$fname', `middlename`='$mname', `lastname`='$lname', `alias`='$alias', `birthplace`='$bplace', `birthdate`='$bdate', 
						age=$age, `civilstatus`='$cstatus',`con`='$costatus', `gender`='$gender', `purok`='$purok', `voterstatus`='$vstatus', `identified_as`='$indetity', `phone`='$number', `email`='$email',`occupation`='$occu',`employed`='$employ', `address`='$address',
				...
				$query = "UPDATE tblresident SET national_id='$national_id',`gv_id`='$gvstatus',citizenship='$citi',`picture`='$newName', `firstname`='$fname', `middlename`='$mname', `lastname`='$lname', `alias`='$alias', `birthplace`='$bplace', `birthdate`='$bdate', 
							age=$age, `civilstatus`='$cstatus',`con`='$costatus', `gender`='$gender', `purok`='$purok', `voterstatus`='$vstatus', `identified_as`='$indetity', `phone`='$number', `email`='$email',`occupation`='$occu',`employed`='$employ', `address`='$address',
							`resident_type`='$deceased', `remarks`='$remarks'
							WHERE id=$id;";
				...
				$query = "UPDATE tblresident SET national_id='$national_id',`gv_id`='$gvstatus',citizenship='$citi',`firstname`='$fname', `middlename`='$mname', `lastname`='$lname', `alias`='$alias', `birthplace`='$bplace', `birthdate`='$bdate', 
							age=$age, `civilstatus`='$cstatus',`con`='$costatus', `gender`='$gender', `purok`='$purok', `voterstatus`='$vstatus', `identified_as`='$indetity', `phone`='$number', `email`='$email',`occupation`='$occu',`employed`='$employ', `address`='$address',
							`resident_type`='$deceased', `remarks`='$remarks'
							WHERE id=$id;";
