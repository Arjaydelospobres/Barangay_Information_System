...
<head>
    ...
    <title>Registered Voters of Camp Tinio</title>
</head>
<body>
                    ...
                    <div class="row mt--2">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card card-stats card-warning card-round">
                                ...
                                <div class="card-body">
                                    <a href="voter_info.php?state=voters" class="card-link text-light">All Voter Resident </a>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats card-secondary card-round">
                                ...
                                <div class="card-body">
                                    <a href="resident_info.php?state=non_voters" class="card-link text-light">All Non-Voter Resident </a>
                                </div>
                            </div>
