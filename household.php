				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white fw-bold">Form Request List</h2>
							</div>
						</div>
					</div>
				</div>
                            ...
                            <div class="card">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title">All Form Request</div>
								...
								<div class="card-body">
									<div class="table-responsive">
										...
										<table  class="display table table-border">
											<thead >
												<tr>
													...
													<th scope="col">Age</th>
													<th scope="col">Zone/BLK</th>
													<th scope="col">Form Requested</th>
