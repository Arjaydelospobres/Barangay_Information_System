                    ...
                    <div class="row mt--2">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card card-stats card-warning card-round">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold">PWD (Person With Disability)</h5>
                                ...
                                <div class="card-body">
                                    <a href="pwd_info.php?state=PWD" class="card-link text-light">All PWD </a>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats card-secondary card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold">Special Child</h5>
                                ...
                                <div class="card-body">
                                    <a href="special_info.php?state=Special Child" class="card-link text-light">All Special Child </a>
                                </div>
                            </div>
                             <div class="card card-stats card-secondary card-round">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-stats">
                                            <div class="numbers mt-4">
                                                <h5 class="fw-bold ">Disease (Heart Failure, Cancer, etc)</h5>
                                ...
                                <div class="card-body">
                                    <a href="diesease_info.php?state=Disease" class="card-link text-light">All Disease </a>
                                </div>
                            </div>
